  ...
  return (
    <div className="flex flex-col flex-1">
      <div className="flex items-center justify-between w-full border-b border-gray-200 py-4 px-6">
        ...
        <div>
          <h1 className="text-xl-semi uppercase">Tandem Textile</h1>
        </div>
                    ...
                    <Link href={`/collections/${collection.handle}`}>
                      ...
                      >
                        <span className="sr-only">
                          Перейти до {collection.title} коллекції
                        </span>
          ...
          <div className="flex flex-col gap-y-8 text-small-regular">
            {!customer ? (
              <div className="flex flex-col gap-y-4">
                <span className="text-gray-700 uppercase">Обліковий запис</span>
              ...
              <div className="flex flex-col gap-y-4">
                <span className="text-gray-700 uppercase">Увійшли як</span>
