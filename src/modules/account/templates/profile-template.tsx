  ...
  return (
    <div className="w-full">
      <div className="mb-8 flex flex-col gap-y-4">
        ...
        Переглядайте та оновлюйте інформацію про свій профіль, включаючи ім'я, електронну пошту та номер телефону. Ви також можете оновити адресу або змінити пароль.
        </p>
      </div>
