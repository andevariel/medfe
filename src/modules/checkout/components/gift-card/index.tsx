...
const GiftCard: React.FC<GiftCardProps> = ({ cart }) => {
  ...
  return (
    <div className="w-full bg-white p-6 flex flex-col">
      <div className="mb-4">
        <h3 className="text-base-semi">Подарункова картка</h3>
      </div>
      <div className="text-small-regular">
        {appliedGiftCard ? (
          <div className="flex items-center justify-between">
            <div>
              <span className="text-gray-700">Код: </span>
            ...
            <div>
              ...
              >
                <Trash size={16} />
                <span className="sr-only">Вилучити подарункову картку з замовлення</span>
              </button>
            </div>
          </div>
        ) : (
